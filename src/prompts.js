...
import { ESTIMATE_DETAILED, ESTIMATE_GENERAL, getEstimateTypeDefault, setEstimateTypeDefault } from './answers';
...
export const askForGeneralEstimate = async () => await prompt(generalEstimateQuestions);
